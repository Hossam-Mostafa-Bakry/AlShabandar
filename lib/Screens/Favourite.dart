                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  ...
                                                  child: Text(
                                                    '${c.price} ' +  DemoLocalizations.of(context).title['currency'] ?? '',
                                                    style: TextStyle(height: 1.2,
                                                        fontSize: 12,
                                                        color: Colors.black),
                                                    maxLines: 2,
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text("${ product.price == null?"0": product.price *counter2 }  "+DemoLocalizations.of(context)
                                          .title['currency']
                                        ,style: TextStyle(fontSize: 14,color: Colors.black,fontWeight: FontWeight.bold),)
                                    ],
                                  ),
                      ...
                      GestureDetector(
                        child: Container(
                            ...
                            child:   Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("${product.price*counter2}"+DemoLocalizations.of(context)
                        ...
                        onTap: () async {
                          ...
                          CartMedelLocal p1=new CartMedelLocal({
                            ...
                            "totalPrice": (product.price * counter2),
                            // "totalPrice": 0.0,
                            "quantity": counter2,
