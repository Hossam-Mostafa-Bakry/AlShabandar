          ...
          Container(
            ...
            child: Row(
              children: [
                Container(
                  width: MediaQuery.of(context).size.width * .3,
                  child: Text(DemoLocalizations.of(context).title['phone'],
                      style: TextStyle(fontSize: 12)),
                ),
                Text(
                    home.phone,
          ...
          Container(
            ...
            child: Row(
              children: [
                Container(
                  width: MediaQuery.of(context).size.width * .3,
                  child: Text(DemoLocalizations.of(context).title['email'],
                      style: TextStyle(fontSize: 12)),
                ),
              ...
              Navigator.pushReplacement(
                ...
                PageRouteBuilder(
                  pageBuilder: (context, animation1, animation2) =>
                      appConfig.prefs.getInt('delmethodvalue') != 2 ?  FourthStepPayment() : SecondStepAddress(),
