...
class SubOfferItem extends StatefulWidget {
  ...
  @override
  State<SubOfferItem> createState() => _SubOfferItemState();
}

class _SubOfferItemState extends State<SubOfferItem> {
                        ...
                        setState(() {
                          if (widget.productoffer != null) {
                            if (widget.quantity > 0) {
                              widget.quantity -= 1;
                              widget.totalPrice = widget.quantity * double.parse(widget.productoffer.price2);
