                  ...
                  ? GestureDetector(
                      onTap: () {
                        Navigator.push(context,
                            GlobalFunction.routeBottom(AddAddress("confirm")));
                      },
                      child: DottedBorder(
        ...
        children: [
          ...
          Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(10)),
                border:
                    Border.all(color: Colors.black12.withOpacity(.1), width: 1),
                color: Colors.white,
                boxShadow: [
                  BoxShadow(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      ...
                      print(
                          '555=${Provider.of<GetDeliveryValueProvider>(context, listen: false).priceDelivery}');
                    },
                    child: Container(
                        height: 30,
                        // color: Colors.red,
                  ...
                  : GestureDetector(
                      onTap: () async {
                        if (index == 1) {
                          ...
                          if (delevery == null) {
                            Toast.show("من فضلك اختر طريقة الشحن", context,
                          ...
                          if (payment == null) {
                            Toast.show("من فضلك اختر طريقة الدفع", context,
                                duration: Toast.LENGTH_SHORT,
                                gravity: Toast.BOTTOM);
                          } else {
                            setState(() {
