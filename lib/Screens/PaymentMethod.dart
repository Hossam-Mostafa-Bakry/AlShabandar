        ...
        body: Directionality(
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: [
                CustomAppBar(
                  DemoLocalizations.of(context).title['paymentmethods'],
                ),
                /*  Container(
                    ...
                    children: [
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: Colors.black12.withOpacity(.03), width: 1),
                          color: Colors.white,
                          boxShadow: [
                            BoxShadow(
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.all(Radius.circular(10)),
                          border:
                              Border.all(color: Color(h.borderColor), width: 1),
                          color: Colors.white,
                        ),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(
                                  color: Color(h.borderColor), width: 1),
                              color: Colors.white,
                            ),
                            padding: EdgeInsets.only(
                              left: MediaQuery.of(context).size.width * .03,
