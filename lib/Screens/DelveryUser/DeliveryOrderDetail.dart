...
class _state extends State<DeliveryOrderDetails> {
                  ...
                  children: [
                    Stack(
                      children: [
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          orderdetails.orderAddress.phone,
                                ...
                                children: [
                                  ...
                                  Container(
                                    width:
                                        MediaQuery.of(context).size.width * .35,
                                    child: Text(
                                      orderdetails.orderAddress.email,
                                      style: TextStyle(fontSize: 12),
                                    ),
                                  )
                                ],
                        ...
                        DemoLocalizations.of(context).locale == Locale("en")
                            ? Positioned(
                                    ...
                                    Text(
                                      DemoLocalizations.of(context)
                                          ...
                                          DemoLocalizations.of(context)
                                              .title['km'],
                                      style:
                                          TextStyle(color: Color(h.blueColor)),
                                    ),
                                    Text(
                                        DemoLocalizations.of(context)
                                                .title['Waitingtime'] +
                                            " ${(double.parse(_placeDistance) / 1.5).round()}" +
                                            DemoLocalizations.of(context)
                                                .title['minute'],
                                        style: TextStyle(
                                            color: Color(h.mainColor)))
  ...
  _makingPhoneCall() async {
    var url = 'tel:${orderdetails.orderAddress.phone}';
                        ...
                        Container(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  DemoLocalizations.of(context)
                                      .title['Confirmordercancellation'],
                                  style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.bold),
                                  textAlign: TextAlign.center,
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: DemoLocalizations.of(context)
                                    .title['Reasonforcancelingtherequest'],
