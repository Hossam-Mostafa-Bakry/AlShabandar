...
class HomeDeliveryOrders extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return _state();
  }
}
class _state extends State<HomeDeliveryOrders>{
  ...
  getOrder(var status_id)async{
    ...
    orders=await orderServices.GetOrdersDelivery(prefs.getString("UserId"), status_id);
    setState(() {
    });
  }
  @override
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(DemoLocalizations.of(
                                                context)
                                                .title[
                                            'requestnumber']+' ' +orders[index].orderNumber,style: TextStyle(height: 1.5,fontSize: 14,fontWeight: FontWeight.bold,color: Color(h.mainColor)),),
                                            SizedBox(height: 3,),
                                            Text(DemoLocalizations.of(
                                                                    context)
                                                                    .title[
                                                                'numberofproducts']+ " ${orders[index].orderDetails.length}",style: TextStyle(height: 1.5,fontSize: 13,color: Colors.black38)),
                                            SizedBox(height: 3,),
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text( DemoLocalizations.of(context)
                                                      .title['Total']
                                                      +' '+" ${orders[index].totalValue}"+DemoLocalizations.of(context)
                                                                        .title['currency'],style: TextStyle(fontSize: 13),),
                                                ],
                                              ),
                                            )
                                          ],
