                    ...
                    ChooseAddress
                        ? addressList.length == 0
                            ? Container(
                                ...
                                child: Text(
                                  "لا يوجد عناوين خاصة بك قم باضافة عنوان ",
                                  style: TextStyle(
                        ...
                        ? GestureDetector(
                            onTap: () {
                              ...
                              Navigator.push(context,
                                  GlobalFunction.route(AddAddress("confirm")));
                            },
                            child: Container(
                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          // color: Colors.red,
                          child: ListTile(
                            title: Text("الدفع بالبطاقة الائتمانية",
                                maxLines: 1,
                                style: TextStyle(
                                    height: .7,
                                    color: Colors.black54,
              ...
              GestureDetector(
                onTap: () {
                  if (address != null)
                    ...
                    Toast.show("  اختر عنوان التوصيل  ", context,
