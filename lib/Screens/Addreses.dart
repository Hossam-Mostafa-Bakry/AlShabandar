  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          DemoLocalizations.of(context).title['listaddresses'],
          style: TextStyle(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                    context, GlobalFunction.routeBottom(AddAddress("add")));
              },
              child: DottedBorder(
                    ...
                    ? Expanded(
                        child: ListView.builder(
                            padding: EdgeInsets.only(
                                left:
                                    MediaQuery.of(context).size.width * .05 - 3,
                                      ...
                                      Column(
                                        children: [
                                          GestureDetector(
                                            ...
                                            child: selected == addressList[index]
                  ...
                  Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            DemoLocalizations.of(context)
                                .title['Confirmdeletionofthisaddress'],
                            style: TextStyle(
