...
class _state extends State<Branches> {
  ...
  String image = 'http://93.112.4.175/mishwar/branch/Thoqba.jpeg';
  ...
  Widget build(BuildContext context) {
    // print('path => http://195.181.247.217/mishwar/branch/${Branches[3].image.substring(35)}');
          ...
          return GestureDetector(
            onTap: () {
              Navigator.push(context,
                  GlobalFunction.route(BrachDetail(Branches[index])));
            },
            child: Container(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: FadeInImage.assetNetwork(
                        ...
                        image: Branches[index].image == null
                            ? ""
                            : 'http://195.181.247.217/mishwar/branch/${Branches[index]
                            .image.substring(35)}',
                        height: MediaQuery
                            .of(context)
                            .size
