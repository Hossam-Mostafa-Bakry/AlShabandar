...
class OrderSuccess extends StatefulWidget {
  ...
  OrderSuccess(int quantity, int order_id, double subtotal, double totle, double tax, double deliveryCost) {
  ...
  State<StatefulWidget> createState() {
    return _state(
        this.quantity, this.order_id, this.subtotal, this.total, this.tax, this.deliveryCost);
  }
}
...
class _state extends State<OrderSuccess> {
  ...
  double deliveryCost;
  _state(
      int quantity, int order_id, double subtotal, double totle, double tax, double deliveryCost) {
    this.quantity = quantity;
    this.order_id = order_id;
    this.subtotal = subtotal;
    this.total = totle;
  ...
  Widget build(BuildContext context) {
    print(Provider.of<GetDeliveryValueProvider>(context, listen: false)
        .priceDelivery);
    return WillPopScope(
      onWillPop: () async {
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              //       // " ${total + deliveryCost} " +
              //       " ${total + Provider.of<GetDeliveryValueProvider>(context, listen: false).priceDelivery} " +
