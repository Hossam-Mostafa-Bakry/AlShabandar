          ...
          children: [
                    ...
                    : GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(
                                color: Color(h.mainColor).withOpacity(.4),
                                width: 1,
                            ),
                            color: Colors.white,
                            boxShadow: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.all(Radius.circular(10)),
                border: Border.all(
                    color: Color(h.mainColor).withOpacity(.4), width: 1),
                color: Colors.white,
                boxShadow: [
                  BoxShadow(
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => FavoriteSideMenu()),
                        );
                        //CartSideMenu
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => OffersSideMenu(),
                          ),
                        );
                      },
                      child: Container(
                          ...
                          GestureDetector(
                            onTap: () async {
                              await appConfig.cApp.changeLanguage(
                                  ...
                                  context);
                              print(
                                  '${appConfig.cApp.appLocale},,,,,from inial');
                              print(
                                  '${appConfig.prefs.getString('lang')},,,,,from shared pref');
                            },
                            child: Container(
                              child: Row(
                                mainAxisAlignment:
